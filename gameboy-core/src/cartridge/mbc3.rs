...
use crate::cartridge::mbc_funcs::ram_banks;
...
impl MBC3 {
    pub fn from_vec(data: Vec<u8>) -> MBC3 {
...
impl Cartridge for MBC3 {
    ...
    fn read(&self, address: Address) -> Result<u8, crate::MemoryError> {
        match address.value() {
            ...
            _ => Err(crate::MemoryError::Read("MBC3", address.index())),
        }
    }
    ...
    fn write(&mut self, address: Address, value: u8) -> Result<(), crate::MemoryError> {
        match address.value() {
            ...
            _ => return Err(crate::MemoryError::Write("MBC3", address.index())),
        }
        Ok(())
    }
...
impl MBC3 {
    ...
    // fn loadram(&mut self, ramdata: &[u8]) -> Result<(), &'static str> {
